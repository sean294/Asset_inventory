$(document).ready(function() {
    ...
    $(document).on('click', '.asset_td_archived', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '.assets_assign_td_archived', function (e) {
        e.preventDefault();
    ...
    // /employees
    //this is for asset_assign dynamic in selecting asset assign id and modal effects
    $(document).on('click', '.emp_archived_td', function (e) {
        e.preventDefault();
    ...
    // /maintenance
    //this is for asset_assign dynamic in selecting asset assign id and modal effects
    $(document).on('click', '.maintenance_td_archived', function (e) {
        e.preventDefault();
